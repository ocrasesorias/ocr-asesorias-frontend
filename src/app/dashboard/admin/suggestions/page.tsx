      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 flex items-center gap-4">
            ...
            <div>
              <p className="text-2xl font-semibold text-foreground">{formatMiles(stats.nuevo, 0)}</p>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 flex items-center gap-4">
            ...
            <div>
              <p className="text-2xl font-semibold text-foreground">{formatMiles(stats.en_proceso, 0)}</p>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 flex items-center gap-4">
            ...
            <div>
              <p className="text-2xl font-semibold text-foreground">{formatMiles(stats.resuelto, 0)}</p>
            ...
            <div className="px-4 py-3 border-t border-gray-200 flex flex-wrap items-center justify-between gap-3 bg-gray-50/50">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="px-3 text-sm text-foreground">
                  Página {formatMiles(page, 0)} de {formatMiles(totalPages, 0)}
                </span>
                <button
                  type="button"
