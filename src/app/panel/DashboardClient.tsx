...
export default function DashboardClient({
  ...
  // Authentication & Organization — datos hidratados desde SSR para evitar
  // el flash de skeleton y mejorar LCP. El hook revalida en background pero no bloquea.
  ...
  if (isLoadingAuth) {
    // Skeleton del shell real: replica el layout para mantener LCP estable
    // y evitar reflow cuando termina la auth y monta el dashboard.
    return (
      <div className="min-h-screen bg-[var(--l-bg,#f9fafb)]">
        {/* Header skeleton */}
        <header className="border-b border-[var(--l-card-border,#e5e7eb)] bg-white">
