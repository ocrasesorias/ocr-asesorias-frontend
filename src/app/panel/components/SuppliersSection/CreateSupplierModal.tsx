    ...
    >
      ...
      >
        <form onSubmit={onSubmit}>
          <div className="p-6">
            <h3 className="text-lg font-semibold text-foreground">Crear proveedor</h3>
            <p className="mt-2 text-sm text-foreground-secondary">
              Introduce los datos del proveedor. Estos se usarán como plantilla al validar facturas.
            </p>
            <div className="mt-4">
              <SupplierForm
                proveedor={nuevoProveedor}
                setProveedor={setNuevoProveedor}
