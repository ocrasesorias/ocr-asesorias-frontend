...
export function UploadItem({
  ...
  return (
    <div
      className={`
        w-full p-3 rounded-none border transition-colors
        ${isSelected
          ? 'border-primary bg-primary/10'
          : 'border-[var(--l-card-border,#e5e7eb)] hover:border-primary/30 hover:bg-primary/5'
        }
      `}
    >
          ...
          {isEditing ? (
            <div className="relative">
              <input
                ...
                className="w-full px-3 py-2 pr-16 border border-[var(--l-card-border,#e5e7eb)] rounded-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all bg-[var(--l-card,#ffffff)]"
                autoFocus
                onKeyDown={(e) => {
              ...
              <div className="absolute inset-y-0 right-2 flex items-center gap-1">
                <button
                  type="button"
                  onClick={onSaveEdit}
                  className="p-1 rounded-none text-primary hover:text-primary-hover hover:bg-primary/10 transition-colors"
                ...
                <button
                  ...
                  className="p-1 rounded-none text-error hover:bg-error/10 transition-colors"
