          ...
          <div className="flex justify-between items-center py-3">
            ...
            <nav className="flex items-center space-x-3">
              <button
                ...
                className="p-2 rounded-none transition-colors" style={{ color: 'var(--l-text-secondary, #6b7280)' }}
              ...
              <Link href="/panel/pendientes" className="p-2 rounded-none transition-colors" style={{ color: 'var(--l-text-secondary, #6b7280)' }} title="Facturas por procesar">
                <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5">
                  <path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </Link>
              <Link href="/panel/admin/suggestions" className="p-2 rounded-none transition-colors" style={{ color: 'var(--l-text-secondary, #6b7280)' }} title="Panel admin">
                <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5">
              ...
              <Link href="/panel/equipo" className="p-2 rounded-none transition-colors" style={{ color: 'var(--l-text-secondary, #6b7280)' }} title="Equipo">
                <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5">
              ...
              <Link href="/panel/preferencias" className="p-2 rounded-none transition-colors" style={{ color: 'var(--l-text-secondary, #6b7280)' }} title="Preferencias">
                <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-6">
        <div className="flex items-center justify-between gap-6">
          <div className="flex items-center gap-3 min-w-0">
            <h2 className="text-2xl font-light text-foreground truncate">
