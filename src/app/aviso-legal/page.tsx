    ...
    <ThemedPage className="min-h-screen relative" style={{ backgroundColor: "var(--l-bg)" }}>
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="p-8 md:p-12" style={{ backgroundColor: "var(--l-card)", border: "1px solid var(--l-card-border)" }}>
          ...
          <h1 className="text-4xl font-bold text-[color:var(--l-text)] mb-4">
            Aviso Legal – KontaScan
          </h1>
          
          <p className="text-[color:var(--l-text-muted)] leading-relaxed mb-8">
          ...
          <div className="prose prose-lg prose-invert max-w-none">
            <section className="mb-8">
              ...
              <ul className="list-none space-y-2 text-[color:var(--l-text-muted)] leading-relaxed">
                <li><strong className="text-[color:var(--l-text)]">Titular:</strong> [Nombre y apellidos / Razón social]</li>
                <li><strong className="text-[color:var(--l-text)]">NIF/CIF:</strong> [NIF o CIF]</li>
                <li><strong className="text-[color:var(--l-text)]">Domicilio:</strong> [Dirección completa]</li>
                <li><strong className="text-[color:var(--l-text)]">Correo electrónico:</strong> [Email de contacto]</li>
              </ul>
