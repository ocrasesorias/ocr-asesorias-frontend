      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pt-20">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none text-foreground">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-foreground mb-4">
                2. Cookies utilizadas en Atajo
              </h2>
              <p className="text-foreground-secondary leading-relaxed mb-4">
                Atajo utiliza exclusivamente cookies técnicas y necesarias para el funcionamiento del sitio web y la autenticación de usuarios.
              </p>
              <p className="text-foreground-secondary leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-foreground-secondary leading-relaxed mb-4">
                Atajo utiliza servicios de terceros que pueden instalar cookies técnicas necesarias para la prestación del servicio, en particular:
              </p>
              <ul className="list-disc list-inside space-y-2 text-foreground-secondary leading-relaxed">
            ...
            <section className="mb-8">
              ...
              <p className="text-foreground-secondary leading-relaxed mb-4">
                Dado que Atajo solo utiliza cookies técnicas necesarias, no es necesario mostrar un banner de consentimiento.
              </p>
              <p className="text-foreground-secondary leading-relaxed">
            ...
            <section className="mb-8">
              ...
              <p className="text-foreground-secondary leading-relaxed">
                Atajo se reserva el derecho a modificar la presente Política de Cookies en caso de incorporar nuevas herramientas o servicios que requieran el uso de cookies adicionales.
              </p>
            </section>
          </div>
